...
import Image1 from "@/assets/IMG_0581.jpg";
const Home = () => {
  return (
    <div className="mt-10 w-full h-[600px]  bg-[#F9F9F9] ">
      <section className="flex md:max-lg:flex flex-col">
        <h1 className="text-6xl font-sans font-extrabold space-x-10 m-16">
          Full-Stack
          <br />
          Web Developer.
        </h1>
        <p className="text-xl font-sans font-medium text-zinc-400 ml-14 -mt-10">
          "A 18-year-old Algerian.Full-stack web developer
          <br /> with a flair for design. Eager to tackle new tech challenges."
        </p>
        <Image
          src={Image1}
          width={220}
          height={220}
          className="absolute left-[910px] top-[120px] rounded-full"
          alt={"Developer"}
        />
        <div className="flex justify-center items-center ml-[430px] mt-52 w-[512px] space-x-2">
          <svg
